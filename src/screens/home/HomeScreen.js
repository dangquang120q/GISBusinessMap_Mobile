                ...
                return (
                  <TouchableOpacity
                    ...
                    <View style={styles.searchResultIconContainer}>
                      <View>
                        <MaterialIcons 
                          name={businessType.businessTypeIcon ? businessType.businessTypeIcon.replace(/_/g, '-') : 'business'} 
                          size={16} 
                          color={businessType.color ? businessType.color : '#666'} 
                        />
                      </View>
                    </View>
